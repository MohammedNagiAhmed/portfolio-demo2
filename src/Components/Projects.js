  ...
  const portfolios = [
    {
      ...
      title: "cart",
      src: ecommerce,
      live: "https://mohammednagiahmed.github.io/cart_demo/",
      code: "https://github.com/MohammedNagiAhmed/cart_demo",
    },
    {
      id: 2,
      title: "every thing for sale",
      src: notes,
      live: "https://mohammednagiahmed.github.io/every-thing-for-sale/",
      code: "https://github.com/MohammedNagiAhmed/every-thing-for-sale",
    },
    {
      id: 3,
      title: "H&M tours",
      src: portfolio,
      live: "https://mohammednagiahmed.github.io/h-m_tours/index.html",
      code: "https://github.com/MohammedNagiAhmed/h-m_tours?tab=readme-ov-file",
    },
  ];
    ...
    >
      <div className="overflow-y-auto max-w-screen-lg p-4 mx-auto flex flex-col justify-center h-full">
        ...
        <div className="flex justify-center">
          ...
          >
            <a
              href="https://github.com/MohammedNagiAhmed"
              target="_blank"
              rel="noreferrer"
            >
              For More Projects
